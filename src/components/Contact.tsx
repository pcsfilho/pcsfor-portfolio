              ...
              <Card className="p-8 border-border bg-card shadow-lg">
                ...
                <div className="space-y-6">
                  {contactInfo.map((info, index) => (
                    ...
                    >
                      <div
                        className={`p-3 rounded-full bg-gradient-to-r from-primary/10 to-secondary/10 mr-4 group-hover:scale-110 transition-transform duration-200`}
                      >
